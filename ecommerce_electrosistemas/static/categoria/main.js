...
document.getElementById('agregar').addEventListener('click', () => {
    new bootstrap.Modal(document.getElementById('modal_categoria')).show(); // Instrucción para mostrar la modal
    let form = document.getElementById('form_categoria') // Instrucción para obtener el objecto (es decir, el formualario)

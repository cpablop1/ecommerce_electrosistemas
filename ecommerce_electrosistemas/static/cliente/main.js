...
// Evento para mostrar la ventana modal para crear clientes
document.getElementById('agregar').addEventListener('click', () => {
    new bootstrap.Modal(document.getElementById('modal_cliente')).show(); // Instrucción para mostrar la modal
    let form = document.getElementById('form_cliente') // Instrucción para obtener el objecto (es decir, el formualario)

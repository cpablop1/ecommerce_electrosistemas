...
document.getElementById('agregar').addEventListener('click', () => {
    new bootstrap.Modal(document.getElementById('modal_marca')).show(); // Instrucción para mostrar la modal
    let form = document.getElementById('form_marca') // Instrucción para obtener el objecto (es decir, el formualario)
...
document.getElementById('form_marca').addEventListener('submit', e => {
